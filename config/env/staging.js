...
const POSTGRES_DB=process.env.POSTGRES_DB || 'syncfab'
...
module.exports = {
  ...
  security: {
    ...
    cors: {
      allRoutes: true,
      allowOrigins: ['https://syncfab.com',
                     'https://www.syncfab.com',
                     'https://apps.syncfab.com',
                     'https://payment.syncfab.com',
                     'https://spi.syncfab.com',],
   ...
   ***************************************************************************/
  custom: {
    // start old payment v1
    'GETH_URL_WS': 'ws://localhost:8546',
    'GETH_LOCAL' : 'http://localhost:8545',
    'ETOKEN2_URL' : 'localhost:18545',
    'GETH_URL' : 'https://9t1f4yor7v5t521m4ra9xh24ggd2q4-node.ambisafe.co',
    'PAYMENT_EXPIRED_IN_SECOND': 15 * 60,
    // end old payment v1
    'CREATE_WALLET_LIMIT': 1,
    'BITGO_ACCESS_TOKEN': 'v2x73e900856dee069be9da82d41464ba9654d54d237ac51d8603574d7278e0d711', //v2x0702b6632aabd341c95b52d10350390982fb17aba62f2996fc41bb0ff98189ae
    'BITGO_WALLET_ID': '5b7b8f15569371a2031e5ceca9d40410',
    'enterprise':'5b7a97267bb06bb8057eead0270b5435',
    'coinWallet':'eth',
    'tokenWallet':['mfg','eth'],
    'tokenIcon':{
      mfg: '/images/token/mfg.png',
      eth: '/images/token/eth.png'},
    'baseUrl':'https://staging-payment.syncfab.com',
    'WEBHOOK_CALLBACK_URL': 'http://208.113.167.215/bitgo',
    'WALLET_URL': 'https://staging-wallet.syncfab.com',
